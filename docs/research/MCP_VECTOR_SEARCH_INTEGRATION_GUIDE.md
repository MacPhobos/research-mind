⚠️ **DEPRECATED - SEE docs/research2/MCP_VECTOR_SEARCH_INTEGRATION_GUIDE.md**

# MCP Vector Search Integration Guide: Phase 1.0 Pre-Phase Setup (DEPRECATED)

**Document Version**: 1.0 (DEPRECATED)
**Date**: 2026-01-31
**Status**: ⚠️ DEPRECATED - Replaced by subprocess-based approach
**Audience**: HISTORICAL REFERENCE ONLY - Use current guide in docs/research2/
**Related Documents**:

- ✅ **CURRENT**: `docs/research2/MCP_VECTOR_SEARCH_INTEGRATION_GUIDE.md` (Version 2.0 - Subprocess-Based)
...
This document describes an **incorrect integration approach** that assumed mcp-vector-search could be embedded as a Python library within research-mind-service.

**Correct Approach**: mcp-vector-search runs as a **subprocess** spawned by research-mind-service on demand.

**Migration**: All implementation should follow the **new guide at `docs/research2/MCP_VECTOR_SEARCH_INTEGRATION_GUIDE.md`**.

---

## DEPRECATED CONTENT BELOW

The following content is kept for historical reference only and should **NOT** be used for new implementation.
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/research_mind  # pragma: allowlist secret
...
# Expected: postgresql://username:password@localhost:5432/research_mind  # pragma: allowlist secret
```
